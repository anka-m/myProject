...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="ie=edge">
    ...
    <title>Anka - Restaurant project</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="${pageContext.request.contextPath}/dist/img/AdminLTELogo.png" alt="Cubes School Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Anka</span>
    </a>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label>Price</label>
                        <form:textarea class="form-control" placeholder="Enter price" path="price"/>                       
                      </div>
                      <div class="form-group">
                        <label>Image</label>
                        <form:textarea class="form-control" placeholder="Enter url" path="image"/>                       
                      </div>
					  <div class="form-group">
